...
<div class="contentTable p-2 mb-3">
    <div class="m-4">
        <form id="createClientForm" action="{{ route('customer.store') }}" method="POST">
            @csrf

            <!-- Campo: Nombre -->
            <div class="mb-3">
                <label for="customer_name" class="form-label">Nombre y Apellido<span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="customer_name" name="customer_name" value="{{ old('customer_name') }}" maxlength="50">
                @error('customer_name')
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="type_phone_id" name="type_phone_id" onchange="togglePhoneInput()">
                    ...
                    @foreach($type_phones as $type)
                        <option value="{{ $type->id }}" {{ old('type_phone_id') == $type->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="customer_phone" name="customer_phone" value="{{ old('customer_phone') }}" maxlength="20">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="customer_address" name="customer_address" value="{{ old('customer_address') }}" maxlength="100">
