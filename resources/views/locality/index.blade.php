...
@section('content')
    ...
    <div class="contentTable p-2 mb-3">
        <div class="m-4">
            <table class="table table-striped table-bordered" id="tableLocality">
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach ($localities as $locality)
                        <tr>
                            <td style="display:none;">{{ $locality->id }}</td>
                            <td>{{ $locality->locality_name }}</td>
                            <td class="lastCol">
                                <!-- Modal de eliminar -->
                                <a href="{{ route('locality.edit', ['id' => $locality->id]) }}" title="Editar"
                                ...
                                <!-- Modal de eliminar -->
                                <a href="#" title="Eliminar" class="btn btn-danger deleteLocalityButton"
    ...
    <script type="module">
        ...
        document.querySelectorAll('.deleteLocalityButton').forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                let localityId = this.getAttribute('data-id');
                let formAction = '{{ url('locality') }}/' + localityId; // Generar la URL de eliminación
